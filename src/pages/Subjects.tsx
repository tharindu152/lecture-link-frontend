...
const programs: Program[] = [
  {
    ...
    description: 'A comprehensive subject covering core concepts in computing.',
    level: Level.BSC,
    durationInDays: 700,
    studentCount: 150,
    batchId: 'CS-B2023',
  ...
  },
  {
    ...
    description:
      'A subject focused on developing business and management skills.',
    level: Level.MSC,
    durationInDays: 900,
    studentCount: 50,
    batchId: 'BA-M2023',
    ...
    instituteId: 102,
    subjects: [
      { id: 3, name: 'Strategic Management', noOfCredits: 4, isAssigned: false },
      {
        id: 4,
  ...
  },
  {
    ...
    description: 'Combining subjectming skills with engineering principles.',
    level: Level.HND,
    durationInDays: 600,
    studentCount: 200,
    batchId: 'SE-H2023',
  ...
  },
  {
    id: 4,
    name: 'Cybersecurity',
    description: 'A subject focused on protecting systems and networks.',
    level: Level.PGD,
    durationInDays: 365,
    studentCount: 30,
    batchId: 'CY-P2023',
    ...
    subjects: [
      ...
      { id: 8, name: 'Ethical Hacking', noOfCredits: 3, isAssigned: false },
    ],
  },
  {
    id: 1,
...
const Subjects = () => {
  ...
  const subjects = programs.map(prog => prog.subjects)
  ...
  const subjectProgramMap = programs.reduce((acc, prog) => {
