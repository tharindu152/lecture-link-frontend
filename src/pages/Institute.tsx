            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <p className="mt-1.5">
                  ...
                  collaborated with British universities to offer undergraduate
                  and postgraduate programs in Sri Lanka since its inception in
                  1990. The Informatics Institute of Technology is a private higher
                  education institute in Sri Lanka that offers specialized
                  offshore British degree programs in IT and Business. IIT has
                  collaborated with British universities to offer undergraduate
                  and postgraduate programs in Sri Lanka since its inception in
