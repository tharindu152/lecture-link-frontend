          ...
          <div className="flex flex-col" title="Search term will be used to find matched from Subject name and description">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`block w-0.75 rounded rounded-md border-[1.5px] border-2 border-gray-500 py-2 px-5 outline-none w-40 transition ${
                    ...
                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                      <p
                        className={`inline-flex rounded-full bg-opacity-10 py-1 px-3 text-sm font-medium ${
                          subject.level.toLowerCase() === 'doctorate'
                            ? 'bg-meta-7 text-meta-7'
                            : subject.level.toLowerCase() === 'masters'
                              ? 'bg-danger text-danger'
                              : subject.level.toLowerCase() === 'bachelors'
                                ? 'bg-primary text-primary'
                                : subject.level.toLowerCase() === 'postgraduate'
                                  ? 'bg-warning text-warning'
                                  : subject.level.toLowerCase() === 'hnd'
                                    ? 'bg-success text-success'
                                    : subject.level.toLowerCase() === 'hnc'
                                      ? 'bg-success text-success'
                                      : ''
                        }`}
                      >
                    ...
                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                      <div className="flex items-center space-x-3.5">
                        <button
                          ...
                          title="View"
                          onClick={() =>
                            handleNavigation(`/app/subjects/filtered-subjects/${subject.id}`)
                          }
                        >
                          <svg
