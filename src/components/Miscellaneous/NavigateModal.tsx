  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-80">
      ...
      <div className="flex justify-center gap-3 mt-4">
          ...
          <button
            className="px-4 py-2 bg-blue-500 text-white rounded dark:bg-blue-600 text-white rounded-lg transition border-2 border-white dark:border-gray-800 hover:border-blue-900 dark:hover:border-blue-400"
            onClick={() =>
              // @ts-ignore
              onClose()}
          >
